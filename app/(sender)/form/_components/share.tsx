...
export const ShareSecond = () => {
  ...
  const handleCopy = async () => {
    try {
      // Use the full link from store (already includes origin)
      await navigator.clipboard.writeText(link || window.location.origin);
      setCopied(true);
  ...
  const handleWhatsAppShare = () => {
    const text = `Check out this message I made for you! 💕`;
    const url = encodeURIComponent(link || window.location.origin);
    window.open(`https://wa.me/?text=${encodeURIComponent(text)}%20${url}`, '_blank');
  };

  const handleEmailShare = () => {
    const subject = encodeURIComponent('A Special Message for You 💌');
    const body = encodeURIComponent(`I created a special message for you!\n\nOpen it here: ${link || window.location.origin}`);
  ...
  return (
    <section className="relative flex h-full w-full flex-col px-3 overflow-hidden">
      ...
      <div className="mx-auto mt-10 flex flex-wrap w-full items-center justify-center max-w-6xl gap-5">
        <button
          type="button"
        ...
        >
          ...
          <div className="relative flex h-[180px] flex-col justify-between">
            ...
            <div>
              ...
              <p className="mt-2 max-w-[260px] text-[14px]/[20px] font-medium text-black/60">
                Send directly via WhatsApp to your recipient.
              </p>
            </div>
          </div>
        </button>
        ...
        >
          ...
          <div className="relative flex h-[180px] flex-col justify-between">
            ...
            <div>
              ...
              <p className="mt-2 max-w-[260px] text-[14px]/[20px] font-medium text-black/60">
                Send through your email client.
              </p>
            </div>
          </div>
        </button>
        ...
        >
          ...
          <div className="relative flex h-[180px] flex-col justify-between">
            ...
            <div>
              ...
              <p className="mt-2 max-w-[260px] text-[14px]/[20px] font-medium text-black/60">
                Preview how your recipient will see it.
              </p>
            </div>
          </div>
        </button>
      ...
      <div className="mx-auto mt-8 max-w-3xl">
        <div className="bg-white/80 backdrop-blur rounded-lg p-4 shadow-md">
          <p className="text-sm text-stone-600 mb-2 font-semibold">Your shareable link:</p>
          <p className="text-lg font-mono break-all text-stone-800">{link || 'Generating...'}</p>
        </div>
      </div>
