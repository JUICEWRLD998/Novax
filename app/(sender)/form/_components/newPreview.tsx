...
const NewPreview = () => {
  ...
  // Check if we should render the new template preview
  const shouldRenderTemplate = template && ['professional', 'elegant'].includes(template);
  ...
  // Legacy playful template view with icon editing
  return (
